...
const Layout = async ({ children }: LayoutProps) => {
    ...
    return <div className='w-full flex h-screen'>
        ...
        <div className='md:hidden'>
            <MobileChatLayout friends={friends} session={session} sideBarOptions={sideBarOptions} unseenReqCount={unseenReqCount} />
        </div>
                ...
                <ul role='list' className='flex flex-1 flex-col gap-y-7'>
                    ...
                    <li>
                        ...
                        <ul role='list' className='-mx-2 mt-2 space-y-1'>
                            ...
                            <li className=''>
                                <FriendRequestSideBarOption sessionId={session.user.id} initialUnseenReqCount={unseenReqCount} />
                            </li>
                        </ul>
                    </li>
